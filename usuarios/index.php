        ...
        <form method="GET" id="filterForm" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                ...
                <div class="md:col-span-2">
                    <a href="<?php echo $base_url; ?>/modulos/personal/nuevo.php" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-2xl font-black shadow-lg shadow-blue-200 transition text-xs flex items-center justify-center gap-2 uppercase tracking-widest active:scale-95">
                ...
                <tr class="hover:bg-blue-50/30 transition group">
                    <td class="px-8 py-5">
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                <a href="<?php echo $base_url; ?>/modulos/personal/editar.php?id=<?php echo $e['id_reloj']; ?>" class="font-black text-slate-800 text-base hover:text-blue-600 transition-colors uppercase"><?php echo htmlspecialchars($e['nombre_completo']); ?></a>
                    ...
                    <td class="px-8 py-5 text-right">
                        <div class="flex items-center justify-end gap-2">
                            <a href="<?php echo $base_url; ?>/modulos/asistencia/historial.php?id=<?php echo $e['id_reloj']; ?>" class="bg-slate-800 hover:bg-black text-white px-5 py-2.5 rounded-xl text-[9px] font-black uppercase tracking-widest shadow-lg transition active:scale-95">Auditoría</a>
                            <a href="<?php echo $base_url; ?>/modulos/personal/editar.php?id=<?php echo $e['id_reloj']; ?>" class="w-10 h-10 flex items-center justify-center bg-blue-50 text-blue-500 rounded-xl hover:bg-blue-600 hover:text-white transition shadow-sm border border-blue-100" title="Editar Expediente"><i class="fas fa-fingerprint"></i></a>
                        </div>
                    </td>
                </tr>
                <?php endforeach; ?>
