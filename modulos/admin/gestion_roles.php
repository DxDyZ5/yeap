...
// Módulos del sistema
$modulos_lista = [
    'Dashboard' => 'modulos/dashboard/index.php',
    'Expediente de Empleados' => 'modulos/personal/editar.php',
    'Listado de Perfiles' => 'modulos/personal/index.php',
    'Historial de Asistencia' => 'modulos/asistencia/historial.php',
    'Constuctor de Carnets' => 'carnets_config.php',
    'Carga de Archivos' => 'cargar_datos.php',
    'Gestión de Ausencias' => 'modulos/asistencia/ausencias.php',
    'Configuración de Evaluación' => 'config_evaluacion.php'
];
