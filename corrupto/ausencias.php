                    ...
                    <tr class="hover:bg-red-50/30 transition group">
                        <td class="px-8 py-5">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <a href="<?php echo modulo_url('personal', 'editar.php', ['id' => $aus['id']]); ?>" class="font-black text-slate-800 uppercase leading-tight hover:text-blue-600 transition-colors">
                        ...
                        <td class="px-8 py-5 text-right">
                            <a href="<?php echo modulo_url('asistencia', 'historial.php', ['id' => $aus['id']]); ?>" class="w-10 h-10 inline-flex items-center justify-center bg-slate-800 hover:bg-black text-white rounded-xl shadow-lg transition transform active:scale-90" title="Ver Historial Detallado">
